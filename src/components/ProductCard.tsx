...
const ProductCard = ({
  ...
  return (
    <motion.div
      className="w-full max-w-[360px] bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group mx-auto"
    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden">
        ...
        />
        <div className="absolute top-2 left-2 bg-rose-500 text-white text-xs font-bold px-2 py-1 rounded-full shadow-md">
          SALE
        </div>

        {/* Quick actions */}
        <div className="absolute top-2 right-2 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <button className="w-7 h-7 flex items-center justify-center bg-white rounded-full shadow hover:bg-gray-100">
      ...
      <div className="p-4">
        ...
        <p className="text-sm text-zinc-600">{txtSlicer(description, 80)}</p>

        {/* Colors */}
        <div className="flex items-center gap-1 mt-2">{renderColors}</div>
